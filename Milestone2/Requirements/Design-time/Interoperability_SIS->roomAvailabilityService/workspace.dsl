workspace "Exam Handling System" "C4 model for EXA project" {
    ...
    model {
        ...
        sis -> healthExa "Requests room availability data" "REST/JSON" "New Change"
        ...
        sis -> appCore "Requests room availability data" "REST/JSON" "New Change"
        ...
        sis -> roomAvailabilityService "Requests room availability data" "REST/JSON" "New Change"
