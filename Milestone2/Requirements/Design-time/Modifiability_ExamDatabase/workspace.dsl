    ...
    model {
        ...
        healthExa = softwareSystem "Exam Handling System (EXA)" "Manages exam terms, registrations, rooms, results and statistics." {
            ...
            appCore = container "Application Core" "Business logic for exam registration, room reservation, credits and grades." "Application service" {
                ...
                statisticsRepository    = component "Statistics Repository" "Reads statistics and results from the Exam Database"
        ...
        statisticsService  -> statisticsRepository  "Reads statistics and results via"       "In-process call"

        statisticsRepository -> exaDb "Reads statistics and results from"                    "JDBC"
        ...
        statisticsRepository -> statsSchema      "Reads aggregated statistics via"           "JDBC/SQL"
